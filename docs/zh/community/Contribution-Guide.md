...
3. 明确标记为“无需帮助”的 Issue（包括 [Byaidu/BilingualPDF](Byaidu/BilingualPDF) 和 [OpenX123/BilingualPDF](OpenX123/BilingualPDF) 仓库中的 Issue）。
4. 维护者认为不合适的其他贡献。
5. 贡献文档，但修改非英语语言的文档。
6. 需要修改 PDF 文件的 PR。
...
6. 在 GitHub 上创建一个 PR，提供详细描述，并请求 [@OpenX123](https://github.com/OpenX123) 进行审查。
7. 确保所有自动化检查通过。
...
向 AI 询问以了解项目：[DeepWiki](https://deepwiki.com/OpenX123/BilingualPDF)
...
> [!TIP]
>
> [Immersive Translate](https://immersivetranslate.com) 为活跃的贡献者提供月度 Pro 会员码。详情请参阅：[BabelDOC/BilingualPDF 贡献者奖励规则](https://funstory-ai.github.io/BabelDOC/CONTRIBUTOR_REWARD/)
