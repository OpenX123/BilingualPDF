...
### Utilizzo di BilingualPDF tramite Webui
...
5. Se distribuisci BilingualPDF con docker e stai utilizzando ollama come backend LLM di BilingualPDF, dovresti inserire "Ollama host" con
