...
3. Issue contrassegnate esplicitamente come "No help needed" (inclusi i problemi nei repository [Byaidu/BilingualPDF](Byaidu/BilingualPDF) e [OpenX123/BilingualPDF](OpenX123/BilingualPDF)).
...
6. Crea una PR su GitHub, fornisci una descrizione dettagliata e richiedi una revisione da [@OpenX123](https://github.com/OpenX123).
...
Chiedi all'AI di comprendere il progetto: [DeepWiki](https://deepwiki.com/OpenX123/BilingualPDF)
...
> [!TIP]
>
> [Immersive Translate](https://immersivetranslate.com) sponsorizza codici mensili di abbonamento Pro per i contributori attivi di questo progetto. Per i dettagli, consultare: [Regole di ricompensa per i contributori di BabelDOC/BilingualPDF](https://funstory-ai.github.io/BabelDOC/CONTRIBUTOR_REWARD/)
