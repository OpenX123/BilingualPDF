...
- **Problema**:
Quando si scaricano modelli da Hugging Face, gli utenti in Cina potrebbero riscontrare errori di rete. Ad esempio, nelle [issue #55](https://github.com/OpenX123/BilingualPDF/issues/55), [#70](https://github.com/OpenX123/BilingualPDF/issues/70).

- **Soluzione**:
  - [Bypass GFW](https://github.com/clash-verge-rev/clash-verge-rev).
  - [Usa lo specchio di Hugging Face](https://hf-mirror.com/).
  - [Usa la versione portatile](https://github.com/OpenX123/BilingualPDF?tab=readme-ov-file#method-ii-portable).
  - [Usa Docker invece](https://github.com/OpenX123/BilingualPDF#docker).
  - [Aggiorna i certificati](https://stackoverflow.com/questions/51925384/unable-to-get-local-issuer-certificate-when-using-requests), come suggerito in [issue #55](https://github.com/OpenX123/BilingualPDF/issues/55).
...
- **Problema**:
L'utilizzo di software proxy in modalità globale potrebbe impedire l'avvio corretto di Gradio. Ad esempio, nel [issue #77](https://github.com/OpenX123/BilingualPDF/issues/77).
