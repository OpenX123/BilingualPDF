...
Il contenuto del file verrà inviato al server del maintainer del progetto [@OpenX123](https://github.com/OpenX123), e poi inoltrato a SiliconFlow per la traduzione.
