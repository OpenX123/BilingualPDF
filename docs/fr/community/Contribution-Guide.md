...
3. Issues explicitement marquées comme "Aucune aide nécessaire" (y compris les issues dans les dépôts [Byaidu/BilingualPDF](Byaidu/BilingualPDF) et [OpenX123/BilingualPDF](OpenX123/BilingualPDF)).
...
6. Créez une PR sur GitHub, fournissez une description détaillée et demandez une revue à [@OpenX123](https://github.com/OpenX123).
...
Demandez à l'IA de comprendre le projet : [DeepWiki](https://deepwiki.com/OpenX123/BilingualPDF)
...
> [!TIP]
>
> [Immersive Translate](https://immersivetranslate.com) sponsorise des codes d'abonnement Pro mensuels pour les contributeurs actifs à ce projet. Pour plus de détails, veuillez consulter : [Règles de récompense des contributeurs BabelDOC/BilingualPDF](https://funstory-ai.github.io/BabelDOC/CONTRIBUTOR_REWARD/)
