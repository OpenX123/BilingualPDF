...
### Utiliser BilingualPDF via Webui
...
5. Si vous déployez BilingualPDF avec docker, et que vous utilisez ollama comme backend LLM de BilingualPDF, vous devez remplir "Ollama host" avec
