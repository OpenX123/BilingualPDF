...
3. Problemas explicitamente marcados como "Sem necessidade de ajuda" (incluindo problemas no repositório [Byaidu/BilingualPDF](Byaidu/BilingualPDF) e no repositório [OpenX123/BilingualPDF](OpenX123/BilingualPDF)).
...
6. Crie um PR no GitHub, forneça uma descrição detalhada e solicite uma revisão de [@OpenX123](https://github.com/OpenX123).
...
Peça à IA para entender o projeto: [DeepWiki](https://deepwiki.com/OpenX123/BilingualPDF)
...
> [!TIP]
>
> [Immersive Translate](https://immersivetranslate.com) patrocina códigos de assinatura Pro mensais para contribuidores ativos deste projeto. Para detalhes, consulte: [BabelDOC/BilingualPDF Regras de Recompensa para Contribuidores](https://funstory-ai.github.io/BabelDOC/CONTRIBUTOR_REWARD/)
