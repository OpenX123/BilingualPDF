...
### Instalar BilingualPDF via arquivo .exe

***Passo 1*** | Baixe `pdf2zh-<version>-with-assets-win64.zip` da [página de lançamentos](https://github.com/OpenX123/BilingualPDF/releases).

> [!TIP]
> **Qual é a diferença entre `pdf2zh-<version>-with-assets-win64.zip` e `pdf2zh-<version>-win64.zip`?**
>
> - Se você está baixando e usando o BilingualPDF pela primeira vez, é recomendado baixar `pdf2zh-<version>-with-assets-win64.zip`.
