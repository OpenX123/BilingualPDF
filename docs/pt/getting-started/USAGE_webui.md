...
5. Se você implantar o BilingualPDF com docker e estiver usando o ollama como o LLM de backend do BilingualPDF, você deve preencher "Ollama host" com
