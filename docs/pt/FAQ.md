...
5. **Check the Server Status**:
   - Visit [BilingualPDF Status Page](https://status.pdf2zh.com) to see if there are any ongoing issues.

If the problem persists, please contact our [Community](#community) or check the [FAQ](#faq) for more help.
- **Problema**:
Ao baixar modelos do hugging face, usuários na China podem encontrar erros de rede. Por exemplo, em [issue #55](https://github.com/OpenX123/BilingualPDF/issues/55), [#70](https://github.com/OpenX123/BilingualPDF/issues/70).

- **Solução**:
  - [Bypass GFW](https://github.com/clash-verge-rev/clash-verge-rev).
  - [Usar espelho do Hugging Face](https://hf-mirror.com/).
  - [Usar versão portátil](https://github.com/OpenX123/BilingualPDF?tab=readme-ov-file#method-ii-portable).
  - [Usar Docker em vez disso](https://github.com/OpenX123/BilingualPDF#docker).
  - [Atualizar certificados](https://stackoverflow.com/questions/51925384/unable-to-get-local-issuer-certificate-when-using-requests), conforme sugerido em [issue #55](https://github.com/OpenX123/BilingualPDF/issues/55).
...
- **Problema**:
Usar software de proxy no modo global pode impedir que o Gradio inicie corretamente. Por exemplo, no [issue #77](https://github.com/OpenX123/BilingualPDF/issues/77).
