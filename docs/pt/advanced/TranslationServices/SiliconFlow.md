...
O conteúdo do arquivo será enviado para o servidor do mantenedor do projeto [@OpenX123](https://github.com/OpenX123) e, em seguida, encaminhado para o SiliconFlow para tradução.
