...
- **Problem**:
Beim Herunterladen von Hugging Face-Modellen können Nutzer in China Netzwerkfehler erhalten. Zum Beispiel in [issue #55](https://github.com/OpenX123/BilingualPDF/issues/55), [#70](https://github.com/OpenX123/BilingualPDF/issues/70).

- **Lösung**:
  - [GFW umgehen](https://github.com/clash-verge-rev/clash-verge-rev).
  - [Hugging Face Mirror verwenden](https://hf-mirror.com/).
  - [Portable Version verwenden](https://github.com/OpenX123/BilingualPDF?tab=readme-ov-file#method-ii-portable).
  - [Stattdessen Docker verwenden](https://github.com/OpenX123/BilingualPDF#docker).
  - [Zertifikate aktualisieren](https://stackoverflow.com/questions/51925384/unable-to-get-local-issuer-certificate-when-using-requests), wie in [Issue #55](https://github.com/OpenX123/BilingualPDF/issues/55) vorgeschlagen.
...
- **Problem**:
Die Verwendung von Proxy-Software im globalen Modus kann verhindern, dass Gradio ordnungsgemäß startet. Zum Beispiel in [Issue #77](https://github.com/OpenX123/BilingualPDF/issues/77).
