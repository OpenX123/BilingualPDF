...
3. Issues, die explizit als "Keine Hilfe benötigt" markiert sind (einschließlich Issues im [Byaidu/BilingualPDF](Byaidu/BilingualPDF)- und [OpenX123/BilingualPDF](OpenX123/BilingualPDF)-Repository).
...
6. Erstellen Sie einen PR auf GitHub, geben Sie eine detaillierte Beschreibung an und fordern Sie eine Überprüfung von [@OpenX123](https://github.com/OpenX123) an.
...
Fragen Sie KI, um das Projekt zu verstehen: [DeepWiki](https://deepwiki.com/OpenX123/BilingualPDF)
...
> [!TIP]
>
> [Immersive Translate](https://immersivetranslate.com) sponsert monatliche Pro-Mitgliedschaftscodes für aktive Mitwirkende an diesem Projekt. Einzelheiten finden Sie unter: [BabelDOC/BilingualPDF Contributor Reward Rules](https://funstory-ai.github.io/BabelDOC/CONTRIBUTOR_REWARD/)
