...
### Verwendung von BilingualPDF über Webui
...
5. Wenn Sie BilingualPDF mit Docker bereitstellen und ollama als Backend-LLM für BilingualPDF verwenden, sollten Sie "Ollama host" mit folgendem Wert ausfüllen:
