...
Die Dateiinhalte werden an den Server des Projektbetreuers [@OpenX123](https://github.com/OpenX123) gesendet und dann an SiliconFlow zur Übersetzung weitergeleitet.
