...
3. Issues marcados explícitamente como "No se necesita ayuda" (incluyendo issues en el repositorio [Byaidu/BilingualPDF](Byaidu/BilingualPDF) y en el repositorio [OpenX123/BilingualPDF](OpenX123/BilingualPDF)).
...
6. Crea un PR en GitHub, proporciona una descripción detallada y solicita una revisión a [@OpenX123](https://github.com/OpenX123).
...
Pregunta a la IA para entender el proyecto: [DeepWiki](https://deepwiki.com/OpenX123/BilingualPDF)
...
> [!TIP]
>
> [Immersive Translate](https://immersivetranslate.com) patrocina códigos de membresía Pro mensuales para los contribuyentes activos de este proyecto. Para más detalles, consulta: [Reglas de recompensa para contribuyentes de BabelDOC/BilingualPDF](https://funstory-ai.github.io/BabelDOC/CONTRIBUTOR_REWARD/)
