...
### Usar BilingualPDF a través de Webui
...
5. Si despliegas BilingualPDF con docker, y estás usando ollama como backend LLM de BilingualPDF, debes llenar "Ollama host" con
