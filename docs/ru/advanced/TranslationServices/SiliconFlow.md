...
Содержание файла будет отправлено на сервер сопровождающего проекта [@OpenX123](https://github.com/OpenX123), а затем перенаправлено в SiliconFlow для перевода.
