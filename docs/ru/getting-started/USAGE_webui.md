...
### Использование BilingualPDF через Webui
...
5. Если вы развертываете BilingualPDF с помощью docker и используете ollama в качестве бэкенд LLM для BilingualPDF, вам следует указать "Ollama host" как:
