...
- **Проблема**:
При загрузке моделей с Hugging Face пользователи в Китае могут столкнуться с ошибкой сети. Например, в [issue #55](https://github.com/OpenX123/BilingualPDF/issues/55), [#70](https://github.com/OpenX123/BilingualPDF/issues/70).

- **Решение**:
  - [Обойти GFW](https://github.com/clash-verge-rev/clash-verge-rev).
  - [Использовать зеркало Hugging Face](https://hf-mirror.com/).
  - [Использовать портативную версию](https://github.com/OpenX123/BilingualPDF?tab=readme-ov-file#method-ii-portable).
  - [Вместо этого использовать Docker](https://github.com/OpenX123/BilingualPDF#docker).
  - [Обновить сертификаты](https://stackoverflow.com/questions/51925384/unable-to-get-local-issuer-certificate-when-using-requests), как предложено в [issue #55](https://github.com/OpenX123/BilingualPDF/issues/55).
...
- **Проблема**:
Использование прокси-программ в глобальном режиме может помешать правильному запуску Gradio. Например, в [issue #77](https://github.com/OpenX123/BilingualPDF/issues/77).
