...
3. Issues, явно помеченные как "No help needed" (включая issues в репозиториях [Byaidu/BilingualPDF](Byaidu/BilingualPDF) и [OpenX123/BilingualPDF](OpenX123/BilingualPDF)).
...
6. Создайте PR на GitHub, предоставьте подробное описание и запросите ревью у [@OpenX123](https://github.com/OpenX123).
...
Спросите ИИ, чтобы понять проект: [DeepWiki](https://deepwiki.com/OpenX123/BilingualPDF)
...
> [!TIP]
>
> [Immersive Translate](https://immersivetranslate.com) спонсирует ежемесячные коды Pro-членства для активных участников этого проекта. Подробности смотрите в разделе: [Правила вознаграждения участников BabelDOC/BilingualPDF](https://funstory-ai.github.io/BabelDOC/CONTRIBUTOR_REWARD/)
