...
### .exe 파일로 BilingualPDF 설치하기

***1 단계*** | [릴리스 페이지](https://github.com/OpenX123/BilingualPDF/releases) 에서 `pdf2zh-<version>-with-assets-win64.zip` 을 다운로드합니다.

> [!TIP]
> **`pdf2zh-<version>-with-assets-win64.zip` 와 `pdf2zh-<version>-win64.zip` 의 차이점은 무엇인가요?**
>
> - BilingualPDF 를 처음 다운로드하여 사용하는 경우 `pdf2zh-<version>-with-assets-win64.zip` 을 다운로드하는 것이 권장됩니다.
