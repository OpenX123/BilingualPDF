...
3. "도움 필요 없음"으로 명시적으로 표시된 이슈 ([Byaidu/BilingualPDF](Byaidu/BilingualPDF) 및 [OpenX123/BilingualPDF](OpenX123/BilingualPDF) 저장소의 이슈 포함).
...
6. GitHub 에서 PR 을 생성하고 상세한 설명을 제공한 후 [@OpenX123](https://github.com/OpenX123) 에게 리뷰를 요청합니다.
...
프로젝트를 이해하기 위해 AI 에게 물어보세요: [DeepWiki](https://deepwiki.com/OpenX123/BilingualPDF)
...
> [!TIP]
>
> [Immersive Translate](https://immersivetranslate.com) 는 이 프로젝트에 활발히 기여하는 기여자들을 위해 월간 Pro 멤버십 코드를 후원합니다. 자세한 내용은 다음을 참조하세요: [BabelDOC/BilingualPDF 기여자 보상 규칙](https://funstory-ai.github.io/BabelDOC/CONTRIBUTOR_REWARD/)
