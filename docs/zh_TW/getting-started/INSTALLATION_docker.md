...
> [!NOTE]
> 
> - 如果您無法訪問 Docker Hub，請嘗試使用 [GitHub Container Registry](https://github.com/OpenX123/BilingualPDF/pkgs/container/pdfmathtranslate) 上的鏡像。
> 
> ```bash
