...
### 通過 .exe 文件安裝 BilingualPDF

***步驟 1*** | 從 [發佈頁面](https://github.com/OpenX123/BilingualPDF/releases) 下載 `pdf2zh-<version>-with-assets-win64.zip`。

> [!TIP]
> **`pdf2zh-<version>-with-assets-win64.zip` 和 `pdf2zh-<version>-win64.zip` 有什麼區別？**
>
> - 如果您是首次下載並使用 BilingualPDF，建議下載 `pdf2zh-<version>-with-assets-win64.zip`。
