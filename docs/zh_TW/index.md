...
- 🌐 支持 [多種語言](https://openx123.github.io/BilingualPDF/supported_languages.html)，以及多樣化的 [翻譯服務](https://openx123.github.io/BilingualPDF/advanced/Documentation-of-Translation-Services.html)。
- 🤖 提供 [命令行工具](https://openx123.github.io/BilingualPDF/getting-started/USAGE_commandline.html)、[互動式用戶界面](https://openx123.github.io/BilingualPDF/getting-started/USAGE_webui.html) 和 [Docker](https://openx123.github.io/BilingualPDF/getting-started/INSTALLATION_docker.html)


> [!WARNING]
>
> 本項目基於 [AGPL v3](https://github.com/OpenX123/BilingualPDF/blob/main/LICENSE) 許可證「按現狀」提供，對程序的質量和性能不作任何保證。**程序的質量和性能的全部風險由您承擔。** 如果程序被發現存在缺陷，您將承擔所有必要的服務、維修或更正費用。
>
> 由於維護者精力有限，我們不提供任何形式的使用協助或問題解答。相關問題將被直接關閉！（歡迎提交改進項目文檔的拉取請求；遵循問題模板的錯誤報告或友好問題不受此影響）


有關如何貢獻的詳細資訊，請參閱 [貢獻指南](https://openx123.github.io/BilingualPDF/community/Contribution-Guide.html)。
...
1. [**Windows EXE**](https://openx123.github.io/BilingualPDF/getting-started/INSTALLATION_winexe.html) <small>推薦用於 Windows</small>
2. [**Docker**](https://openx123.github.io/BilingualPDF/getting-started/INSTALLATION_docker.html) <small>推薦用於 Linux</small>
3. [**uv** (a Python package manager)](https://openx123.github.io/BilingualPDF/getting-started/INSTALLATION_uv.html) <small>推薦用於 macOS</small>
...
有關詳細說明，請參閱我們的 [高級用法](https://openx123.github.io/BilingualPDF/advanced/advanced.html) 文檔，以獲取每個選項的完整列表。
...
如果您不知道應該使用什麼代碼來翻譯成您需要的語言，請查閱 [此文檔](https://openx123.github.io/BilingualPDF/advanced/Language-Codes.html)
...
我們歡迎貢獻者的積極參與，讓 pdf2zh 變得更好。在您準備提交代碼之前，請參考我們的 [行為準則](https://openx123.github.io/BilingualPDF/community/CODE_OF_CONDUCT.html) 和 [貢獻指南](https://openx123.github.io/BilingualPDF/community/Contribution-Guide.html)。
