...
3. 明確標記為「無需幫助」的 Issue（包括 [Byaidu/BilingualPDF](Byaidu/BilingualPDF) 和 [OpenX123/BilingualPDF](OpenX123/BilingualPDF) 倉庫中的 Issue）。
4. 維護者認為不適當的其他貢獻。
5. 貢獻文檔，但修改非英文語言的文檔。
6. 需要修改 PDF 檔案的 PR。
...
6. 在 GitHub 上建立一個 PR，提供詳細的描述，並向 [@OpenX123](https://github.com/OpenX123) 請求審查。
7. 確保所有自動化檢查都通過。
...
向 AI 詢問以了解專案：[DeepWiki](https://deepwiki.com/OpenX123/BilingualPDF)
...
> [!TIP]
>
> [Immersive Translate](https://immersivetranslate.com) 為本專案的活躍貢獻者贊助每月 Pro 會員碼。詳情請見：[BabelDOC/BilingualPDF 貢獻者獎勵規則](https://funstory-ai.github.io/BabelDOC/CONTRIBUTOR_REWARD/)
