...
- **Issue**:  
When downloading hugging face models, users in China may get network error. For example, in [issue #55](https://github.com/OpenX123/BilingualPDF/issues/55), [#70](https://github.com/OpenX123/BilingualPDF/issues/70).

- **Solution**:
  - [Bypass GFW](https://github.com/clash-verge-rev/clash-verge-rev).
  - [Use Hugging Face Mirror](https://hf-mirror.com/).
  - [Use Portable version](https://github.com/OpenX123/BilingualPDF?tab=readme-ov-file#method-ii-portable).
  - [Use Docker instead](https://github.com/OpenX123/BilingualPDF#docker).
  - [Update Certificates](https://stackoverflow.com/questions/51925384/unable-to-get-local-issuer-certificate-when-using-requests), as suggested in [issue #55](https://github.com/OpenX123/BilingualPDF/issues/55).
...
- **Issue**:  
Using proxy software in global mode may prevent Gradio from starting properly. For example, in [issue #77](https://github.com/OpenX123/BilingualPDF/issues/77).
